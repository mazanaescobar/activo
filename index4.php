...
<form method="post" action="" >
  <fieldset>
    ...
    <legend  style="font-size: 40pt"><b>Reguistro de bienes</b></legend>

    <div class="form-group">
      <label style="font-size: 14pt">Nombre</label>
      <input type="text" name="nombre" class="form-control"  required placeholder="Nombre" />
    </div>
    <div class="Tipo de biene">
      <label style="font-size: 14pt"><b>tipo de bien</b></label>
      <input type="text" name="tipo_de_bien" class="form-control"  required placeholder="Tipo de bien"/>
    </div>
...
<h2> Bienes ingresados</h2>	
<a target="_blank" href="fpdf/tutorial/bienes.php" class="btn btn-danger">Exportar a PDF</a> 
			...
			<?php 
				 while($arreglo=mysql_fetch_array($query)){
				  	echo "<tr class='success'>";
				    	...
				    	echo "<td><a href='actualizar4.php?idbienes=$arreglo[0]'><img src='images/actualizar.gif' class='img-rounded'></td>";
						echo "<td><a href='index4.php?idbienes=$arreglo[0]&idborrar=2'><img src='images/eliminar.png' class='img-rounded'/></a></td>";
				...
				echo "</table>";
					...
					if(@$idborrar==2){
						...
						$sqlborrar="DELETE FROM bienes WHERE idbienes=$idbienes";
