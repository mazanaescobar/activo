...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		<form action="ejecutaactualizar5.php" method="post">
				Id<br><input type="text" name="idpersonas" value= "<?php echo $idpersonas ?>" readonly="readonly"><br>
				Cargo<br> <input type="text" name="cargo" required value="<?php echo $cargo?>"><br>
				...
				Edificio<br> <input type="text" name="edificio" required value="<?php echo $edificio?>"><br>
