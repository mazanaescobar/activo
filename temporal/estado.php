...
$pdf->Cell(17, 6, 'Correlativo', 1);
$pdf->Cell(25, 6, 'Marca', 1);
$pdf->Cell(25, 6, 'Modelo', 1);
$pdf->Cell(25, 6, 'Encargado', 1);
$pdf->Cell(13, 6, 'Precio', 1);
$pdf->Cell(9, 6, 'Idpro', 1);
$pdf->Cell(16, 6, 'FCompra', 1);
$pdf->Cell(15, 6, 'Estado', 1);
$pdf->Ln(6);
$pdf->SetFont('Arial', '', 8);

$articulos= mysql_query("SELECT * FROM activo_fijo");
$item = 0;
$totaluni = 0;
while($articulos2 = mysql_fetch_array($articulos)){
	...
	$pdf->Cell(15, 8,$articulos2['estado'], 1);
	$pdf->Ln(8);
}
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(145,8,'',0);
