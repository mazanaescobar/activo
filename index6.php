...
<form method="post" action="" >
  <fieldset>
    ...
    <legend  style="font-size: 40pt"><b>Reguistro de proveedores</b></legend>

    <div class="form-group">
      <label style="font-size: 14pt">Nombre</label>
      <input type="text" name="nombre" class="form-control"  required placeholder="Poner nombre" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Apellido</b></label>
      <input type="text" name="apellido" class="form-control"  required placeholder="Poner apellido"/>
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Teléfono</b></label>
      <input type="" name="telefono" class="form-control"  placeholder="22222222" />
    </div>
    <div class="form-group">
      <label style="font-size: 14pt"><b>Empresa a la qué pertenece</b></label>
